...
const sections = [
  ...
  },
  {
    ...
    content:
      "Compose a new email to your own address or a friend to verify that your Outlook account is working correctly.",
    image: "sendtest.jpg",
  },
  {
    title: "Check Outlook Notifications",
    content:
      "Make sure notifications are enabled so you don't miss new emails. In Outlook, go to Settings > Notifications, and turn on desktop and sound alerts if available.",
    image: "notification-step.jpg",
    success: true,
  },
];
